      ...
      <div className="custom-software-page">
        ...
        <section className="hero" id="hero">
          ...
          <div className="hero-content" style={{ marginTop: '4rem', marginLeft: '5rem' }}>
            ...
            <div className="hero-meta">
              ...
              <div className="hero-actions" style={{ display: 'flex', flexDirection: 'row', gap: '1rem', marginTop: '1.5rem', alignItems: 'center' }}>
                ...
                <a href="#contact" className="btn-g" style={{ fontSize: '1.05rem', padding: '12px 28px', whiteSpace: 'nowrap', display: 'inline-block', textAlign: 'center' }}>Free Consultation</a>
              </div>
            </div>
          </div>
          ...
          <div className="hero-visual" style={{ marginTop: '3rem' }}>
            {/* Terminal mockup */}
            <div className="hero-terminal" style={{ transform: 'scale(1.2)', transformOrigin: 'center' }}>
