...
interface CaseStudyDetailPageProps {
  params: Promise<{
    id: string; // Keep 'id' here for the route parameter, but use 'slug' for data fetching
  }>;
}

export default function CaseStudyDetailPage({ params }: CaseStudyDetailPageProps) {
  const resolvedParams = React.use(params);
  const { id: slug } = resolvedParams; // Destructure and rename 'id' to 'slug'
  ...
  const articleStructuredData: WithContext<Article> = {
    ...
    "image": caseStudy.image ? `https://www.hynox.in${caseStudy.image}` : "https://www.hynox.in/hynox_logo.jpg", // Fallback to a default image if not present
    "author": {
      "@type": "Organization",
      "name": "HYNOX"
    },
    ...
    "datePublished": "2023-01-01", // Placeholder, ideally this would come from caseStudy data
    "dateModified": "2023-01-01", // Placeholder, ideally this would come from caseStudy data
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": `https://www.hynox.in/case-studies/${caseStudy.slug}`
    }
  };
