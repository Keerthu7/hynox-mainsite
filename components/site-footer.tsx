        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          ...
          >
            ...
            <div className="flex items-center gap-6">
              ...
              <Link 
                href="https://www.facebook.com/share/1CCgVGqULd/?mibextid=wwXIfr" 
                target="_blank"
                rel="noopener noreferrer"
                className="group"
              >
              ...
              <Link 
                href="https://youtube.com/@hynox_in?si=MMrfavm1rtMi2X-6" 
                target="_blank"
                rel="noopener noreferrer"
                className="group"
              >
                ...
                >
                  <svg
                    ...
                    className="text-gray-500 group-hover:text-gray-300 transition-colors duration-300"
                  >
                    <path d="M2.5 17.5v-11c0-1.4 1.1-2.5 2.5-2.5h14c1.4 0 2.5 1.1 2.5 2.5v11c0 1.4-1.1 2.5-2.5 2.5h-14c-1.4 0-2.5-1.1-2.5-2.5z"></path>
          ...
          >
            ...
            <ul className="space-y-4">
              {[
                ...
                { name: "Mobile Development", href: "/services/mobile-applications" },
                { name: "Custom Software", href: "/services/custom-software" },
                { name: "Shopify Solutions", href: "/services/shopify-store-development" },
