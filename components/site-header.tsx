...
export function SiteHeader() {
  ...
  const navigationItems = [
    ...
    { name: "Voice.ai", href: "https://voice.hynox.in" },
  ];
                  ...
                  >
                    {item.name === "Voice.ai" ? (
                      <Link
                        href={item.href}
                        target="_blank"
                        className="relative flex items-center gap-2 bg-gradient-to-r from-purple-700 to-pink-500 text-white px-4 py-2 rounded-md transition-all duration-300 font-light text-sm tracking-wider hover:from-purple-600 hover:to-pink-400 hover:shadow-lg"
                      >
                        <Bot size={16} />
                        {item.name}
                      </Link>
                    ...
                    >
                      {item.name === "Voice.ai" ? (
                        <Link
                          href={item.href}
                          target="_blank"
                          className="relative justify-center flex items-center gap-2 bg-gradient-to-r from-purple-700 to-pink-500 text-white px-4 py-2 rounded-md transition-all duration-300 font-light text-sm tracking-wider hover:from-purple-600 hover:to-pink-400 hover:shadow-lg"
                        >
                          <Bot size={16} />
                          {item.name}
                        </Link>
